...
@Entity // fala para o SpringBoot que esta classe possui uma tabela correspondente no bd
@Table(name="TB_USUARIO")  // Identifica qual é a tabela que estará associada com a classe Usuario

public class Usuario {
	
	@Id // avisa para o SpringBoot que esta coluna é chave primária da tabela
